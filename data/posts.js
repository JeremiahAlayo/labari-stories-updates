export const posts = [
  {
    ...
    socialChannel: "Website, Instagram, X",
    readTime: "4 min read",
    status: "published",
    imageTone: "green",
    content: [
  ...
  },
  {
    ...
    platformArea: "Browse",
    audience: "Readers",
    authorId: "social-media-team",
    authorName: "Social Media Team",
    canPublishDirectly: true,
  ...
  },
  {
    ...
    authorName: "Social Media Team",
    canPublishDirectly: true,
    socialChannel: "Website, Instagram, Facebook",
    readTime: "3 min read",
    status: "draft",
    imageTone: "green",
    content: [
      {
        ...
        paragraphs: [
          "This post is intentionally marked as draft and does not appear on the public blog index."
        ]
      }
    ]
  }
